...
| Platform | Package |
|-----------|----------|
| Debian 13 (Trixie), x86-64 | `debs/asl3-chan-svx_0.3.1~trixie_amd64.deb` |
| Debian 13 (Trixie), ARM64 (Raspberry Pi OS Trixie) | `debs/asl3-chan-svx_0.3.1~trixie_arm64.deb` |
| Debian 12 (Bookworm), x86-64 | `debs/asl3-chan-svx_0.3.1~bookworm_amd64.deb` |
| Debian 12 (Bookworm), ARM64 (Raspberry Pi OS Bookworm) | `debs/asl3-chan-svx_0.3.1~bookworm_arm64.deb` |
...
```sh
sudo apt install ./debs/asl3-chan-svx_0.3.1~<os>_<arch>.deb
```
